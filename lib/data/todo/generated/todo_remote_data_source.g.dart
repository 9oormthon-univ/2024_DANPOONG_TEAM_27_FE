...
class _TodoRemoteDataSource implements TodoRemoteDataSource {
  ...
  @override
  Future<void> createTodo({required CreateTodoRequestBody body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
  ...
  @override
  Future<void> toggleTodoComplete({required int todoId}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<void> updateTodo({required UpdateTodoRequestBody body}) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
