...
class MissionDeleteBottomSheet extends StatelessWidget {
  final String title;
  const MissionDeleteBottomSheet({super.key, required this.title});
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(left: 8.0, top: 4.0, bottom: 36.0),
              child: Row(children: [
                Text(title, style: LuckitTypos.suitSB16.copyWith(color: LuckitColors.black),),
              ],),
            ),
            Text(
              '이 미션을 정말로 삭제하시겠습니까?',
